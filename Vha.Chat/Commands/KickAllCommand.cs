...
namespace Vha.Chat.Commands
{
    public class KickAllCommand : Command
    {
        public override bool Process(Context context, string trigger, string message, string[] args)
        {
            ...
            context.Write(MessageClass.PrivateChannel, "Kicking all characters from your private channel");
            return true;
        }
        ...
        public KickAllCommand()
            : base(
                ...
                // Description
                "The kickall command allows you to kick all characters from your private channel."
            )
        { }
    }
}
